...
There are a lot of lines between 440 Hz to 5KHz.  These represent the synthesizer key tones. Also, the key strokes are audible along with background noise.\\
\begin{figure}[ht!]
	\centering
