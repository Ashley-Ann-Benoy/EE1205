...
\begin{lstlisting}
$https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/song.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/values.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/values.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/m.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/l.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/k.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/p.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/q.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/r.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/s.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/t.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/u.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/audio/codes/v.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\\
\solution The given butterworth filter is lowpass with order=4 and cutoff-frequency=2kHz.
